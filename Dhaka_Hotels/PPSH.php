...
<body>
 <ul>
  ...
  <li><a href="PPSH_admin.php">Admin Panel</a></li>
  <li><a href="FQAB.php" style="color: yellow;">Fare Query And Booking</a></li>
 </ul>

 <div class="hotel_list">
 	<li><a href="#" style="border-top:1px solid black; background-color: #4CAF50">Pan Pacific Sonargaon Hotel</a></li>
 	<li><a href="RBH.php">Ruposhi Bangla Hotel</a></li>
...
$check = "SELECT * FROM dhaka_hotels WHERE ID = 1";
